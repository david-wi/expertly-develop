...
| Command | `apps/command` | https://command.ai.devintensive.com | Queue-driven task management |
...
| Intake | `apps/intake` | https://intake.ai.devintensive.com | Intake management |
