...
// Note: width/height attributes provide fallback sizing when Tailwind CSS classes
// aren't applied (e.g., module federation CSS loading issues). CSS classes override these.
export function ExpertlyLogo({ className = 'w-8 h-8' }: { className?: string }) {
  return (
    <svg className={className} width="32" height="32" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
