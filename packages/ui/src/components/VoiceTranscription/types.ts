...
export interface UseDeepgramWebSocketOptions { tokenUrl: string; onTranscript: (transcript: TranscriptMessage) => void; onError?: (error: VoiceTranscriptionError) => void }
