...
describe('LandingPage', () => {
  ...
  it('renders the product name in navigation', () => {
    renderWithRouter(<LandingPage />)
    expect(screen.getAllByText('Expertly Command').length).toBeGreaterThan(0)
  })
  ...
  it('renders the before/after comparison section', () => {
    ...
    expect(screen.getByText('Without Expertly Command')).toBeInTheDocument()
    expect(screen.getByText('With Expertly Command')).toBeInTheDocument()
  })
