...
class UUID(TypeDecorator):
    ...
    Accepts as_uuid parameter for API compatibility but ignores it since we
    always return UUID objects.
    """
    impl = CHAR
    cache_ok = True

    def __init__(self, as_uuid=True):
        # Accept as_uuid for compatibility but always work as UUID
        super().__init__()
...
# For ARRAY, we'll use JSON serialization for SQLite
