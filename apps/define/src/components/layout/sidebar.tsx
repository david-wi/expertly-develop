...
import { Home, FolderTree, Package, Settings, ChevronDown } from 'lucide-react';
      ...
      <div className="relative">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-900">Expertly Define</span>
          </div>
              ...
              <div className="p-2">
                ...
                {EXPERTLY_PRODUCTS.map((product) => (
                  <a
                    ...
                    onClick={() => setShowProductSwitcher(false)}
                  >
                    <div className={cn('w-8 h-8 rounded-lg flex items-center justify-center', product.color)}>
