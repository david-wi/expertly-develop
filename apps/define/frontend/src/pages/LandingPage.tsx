...
const features = [
  {
    name: 'Hierarchical Requirements',
    description: 'Organize requirements in a tree structure. Group by features, epics, or any hierarchy that fits your workflow.',
    icon: Layers,
  },
  {
    name: 'AI-Powered Import',
    description: 'Import requirements from text, PDFs, or images. AI extracts and structures requirements automatically.',
    icon: Sparkles,
  },
  {
    name: 'Version History',
    description: 'Track every change with complete version history. See who changed what and when, with easy rollback.',
    icon: History,
  },
  {
    name: 'Release Snapshots',
    description: 'Capture point-in-time snapshots of your requirements for each release. Track verification status.',
    icon: Target,
  },
  {
    name: 'Jira Integration',
    description: 'Draft user stories from requirements and push them directly to Jira. Keep everything in sync.',
    icon: GitBranch,
  },
  {
    name: 'Document Management',
    description: 'Attach artifacts, specifications, and supporting documents. Convert between formats automatically.',
    icon: BookOpen,
  },
]
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              AI-powered requirements management that keeps your team aligned.
              Import from anywhere, track changes, and ship with confidence.
            </p>
            ...
            <div className="bg-gradient-to-b from-primary-100 to-primary-50 rounded-2xl shadow-xl overflow-hidden border border-primary-200">
              <div className="aspect-video flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 m-4 rounded-lg">
                <div className="text-center">
                  <ClipboardList className="w-16 h-16 text-white/80 mx-auto" />
                  <p className="mt-4 text-white/60 text-sm">Requirements Dashboard</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Powerful features that make requirements management effortless.
            </p>
          </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Three steps to better requirements
            </h2>
            <p className="mt-4 text-lg text-gray-600">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="mt-3 text-gray-600">
                Upload documents, paste text, or let AI extract requirements from PDFs and images.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold">
              ...
              <p className="mt-3 text-gray-600">
                Structure requirements hierarchically. Add details, acceptance criteria, and link to artifacts.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold">
              ...
              <p className="mt-3 text-gray-600">
                Create release snapshots, push to Jira, and track verification status through delivery.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-primary-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-primary-100">
            Join teams who ship better products with clear, traceable requirements.
          </p>
          <Link
            to="/"
