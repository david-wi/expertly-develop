...
class AIService:
    ...
    def analyze_page_screenshot(
        ...
        try:
            # Get model config for page analysis
            model_config = _get_model_config_sync("page_analysis")
            logger.debug(f"Using model {model_config['model_id']} for page analysis")
...
Return ONLY valid JSON array."""
            ...
            # Get model config for test generation
            model_config = _get_model_config_sync("test_generation")
            logger.debug(f"Using model {model_config['model_id']} for test generation")
...
Return ONLY valid JSON.""",
            ...
            # Get model config for failure analysis
            model_config = _get_model_config_sync("failure_analysis")
            logger.debug(f"Using model {model_config['model_id']} for failure analysis")
