...
from app.api.test_scenarios import router as test_scenarios_router
...
api_router.include_router(test_scenarios_router, prefix="/test-scenarios", tags=["test-scenarios"])
