...
MONITORED_SERVICES: list[ServiceConfig] = [
    ...
    ServiceConfig(name="Define", url="https://define.ai.devintensive.com", health_endpoint="/api/health"),
    ...
    ServiceConfig(name="QA (Vibetest)", url="https://qa.ai.devintensive.com", health_endpoint="/"),
