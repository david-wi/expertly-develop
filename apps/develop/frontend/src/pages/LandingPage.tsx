    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Expertly Develop</span>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              Generate beautiful step-by-step guides for your web applications in minutes.
              No more manual screenshots. No more outdated documentation.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Powerful features that make creating visual walkthroughs effortless.
            </p>
          </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
              Three steps to perfect walkthroughs
            </h2>
            <p className="mt-4 text-lg text-gray-600">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="mt-3 text-gray-600">
                Point us to your web application. We support any publicly accessible URL.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold">
              ...
              <p className="mt-3 text-gray-600">
                Tell us what workflow to document. Use natural language or pick from templates.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-600 rounded-full flex items-center justify-center mx-auto text-white text-2xl font-bold">
              ...
              <p className="mt-3 text-gray-600">
                Receive a polished visual guide ready to share with your users.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-primary-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-primary-100">
            Join teams who save hours every week with automated visual guides.
          </p>
          <Link
            to="/"
      ...
      <footer className="bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <ExpertlyLogo className="w-8 h-8" />
              <span className="text-lg font-bold text-white">Expertly Develop</span>
            </div>
