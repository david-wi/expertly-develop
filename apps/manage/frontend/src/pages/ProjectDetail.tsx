      ...
      >
        <form onSubmit={handleCreateTask} className="space-y-4">
          ...
          <div className="border-t pt-4">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-sm font-medium text-gray-700">Make this a recurring assignment</span>
            </label>
          ...
          <ModalFooter>
            ...
            >
              {saving ? 'Creating...' : taskForm.is_recurring ? 'Create Recurring Assignment' : 'Create Assignment'}
            </button>
          </ModalFooter>
        </form>
      </Modal>
